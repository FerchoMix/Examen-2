...
$('#addCliente').onclick=async()=>{
  ...
  // 🔻 Convierte la imagen subida a Data URL y guárdala en IndexedDB
  let fotoFinal = '';
...
// RESEÑAS (toman la foto del cliente automáticamente)
...
$('#addProducto').onclick=async()=>{
  ...
  let img='';
  if(file){
    // 🔻 Convierte la imagen subida a Data URL para guardarla
